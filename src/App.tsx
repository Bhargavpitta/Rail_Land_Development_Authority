...
import Station from "./pages/Projects/Station";
import Commercial from "./pages/Projects/Commercial";
import Colony from "./pages/Projects/Colony";
import Mfc from "./pages/Projects/Mfc";
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<Layout />}>
            ...
            <Route path="/projects/station" element={<Station />} />
            <Route path="/projects/commercial" element={<Commercial />} />
            <Route path="/projects/mfc" element={<Mfc />} />
            <Route path="/projects/colony" element={<Colony />} />
